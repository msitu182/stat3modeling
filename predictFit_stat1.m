function predictFit_stat1(dataFull,dose1,doseResponse1,dose2,doseResponse2,dose3,doseResponse3,zeroPoint,atanSol1,atanSol2,atanSol3);
...
if (choice == 1)  %predict il6, osm
    w12 = dualResponseFit_stat1(dataFull,dose1,doseResponse1,dose2,doseResponse2,dose3,doseResponse3,zeroPoint,1,2,atanSol1,atanSol2,atanSol3);
    w23 = dualResponseFit_stat1(dataFull,dose1,doseResponse1,dose2,doseResponse2,dose3,doseResponse3,zeroPoint,2,3,atanSol1,atanSol2,atanSol3);
    ...
    doseResponse13 = [dataFull(selectDose(1,0,1),5); dataFull(selectDose(1,0,2),5); dataFull(selectDose(1,0,3),5); ...
        dataFull(selectDose(2,0,1),5); dataFull(selectDose(2,0,2),5); dataFull(selectDose(2,0,3),5); ...
        dataFull(selectDose(3,0,1),5); dataFull(selectDose(3,0,2),5); dataFull(selectDose(3,0,3),5);];
    doseResponse13 = doseResponse13 - zeroPoint;
    
    %set negative values to 0 minimum?
    [sizeDualData,~] = size(doseResponse13);
...
elseif (choice == 2) %predict ifng,osm
    w12 = dualResponseFit_stat1(dataFull,dose1,doseResponse1,dose2,doseResponse2,dose3,doseResponse3,zeroPoint,1,2,atanSol1,atanSol2,atanSol3);
    w13 = dualResponseFit_stat1(dataFull,dose1,doseResponse1,dose2,doseResponse2,dose3,doseResponse3,zeroPoint,1,3,atanSol1,atanSol2,atanSol3);
    ...
    dataFull = table2array(dataFull);
    doseResponse23 = [dataFull(selectDose(0,1,1),5); dataFull(selectDose(0,1,2),5); dataFull(selectDose(0,1,3),5); ...
        dataFull(selectDose(0,2,1),5); dataFull(selectDose(0,2,2),5); dataFull(selectDose(0,2,3),5); ...
        dataFull(selectDose(0,3,1),5); dataFull(selectDose(0,3,2),5); dataFull(selectDose(0,3,3),5)];
    doseResponse23 = doseResponse23 - zeroPoint;
    
    %set negative values to 0 minimum?
    [sizeDualData,~] = size(doseResponse23);
    for i = 1:sizeDualData
...
elseif (choice == 3) %predict il6,ifng
    ...
    dataFull = table2array(dataFull);
    doseResponse12 = [dataFull(selectDose(1,1,0),5); dataFull(selectDose(1,2,0),5); dataFull(selectDose(1,3,0),5); ...
        dataFull(selectDose(2,1,0),5); dataFull(selectDose(2,2,0),5); dataFull(selectDose(2,3,0),5); ...
        dataFull(selectDose(3,1,0),5); dataFull(selectDose(3,2,0),5); dataFull(selectDose(3,3,0),5);];
